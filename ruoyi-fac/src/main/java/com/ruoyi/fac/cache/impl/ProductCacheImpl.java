...
public class ProductCacheImpl implements ProductCache {
    ...
    @Override
    public Product getProductCache(String prodId) throws Exception {
    ...
    @Override
    public FacProduct getFacProductCache(String prodId) throws Exception {
    ...
    @Override
    public void deleteProdCache(String prodId) throws Exception {
        String key = String.format(CacheKeys.KEY_PRODUCT, prodId);
        this.stringRedisTemplate.delete(key);
    }

    @Override
    public void deleteFacProdCache(String prodId) throws Exception {
        String key = String.format(CacheKeys.KEY_FAC_PRODUCT, prodId);
        this.stringRedisTemplate.delete(key);
    }
}
