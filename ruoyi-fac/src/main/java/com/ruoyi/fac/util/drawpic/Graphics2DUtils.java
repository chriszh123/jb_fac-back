...
public class Graphics2DUtils {
     ...
     * @param center      是否居中
     */
    public static void drawString(Graphics2D g, Color color, Font font, String content, float x, float y, int width
            , int lineWordNum, int linePadding, boolean center) {
