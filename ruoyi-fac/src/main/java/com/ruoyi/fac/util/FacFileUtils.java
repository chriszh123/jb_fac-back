 ...
 **/
public class FacFileUtils {
    private static final Logger logger = LoggerFactory.getLogger(FacFileUtils.class);

    private static FacFileUtils instance = null;
    private static final Object obj = new Object();

    public static FacFileUtils getInstance() {
        if (instance == null) {
            synchronized (obj) {
                if (instance == null) {
                    instance = new FacFileUtils();
                }
            }
        }
        return instance;
