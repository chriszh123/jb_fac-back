...
public class PayCommonUtil {
    ...
    //微信参数配置
    private static AppMchVo appMch;
     ...
     * @return -
     */
    public static SortedMap<String, Object> WxPublicPay(String trade_no, BigDecimal totalAmount, String description, String attach
            , String openId, String wxnotify, AppMchVo appMchVo, HttpServletRequest request) throws Exception {
        appMch = appMchVo;
        ...
        finalpackage.put("appId", appMch.getAppId());
        ...
        String sign = createSign(finalpackage);
     ...
     * @return -
     */
    private static Map<String, String> weixinPrePay(String trade_no, BigDecimal totalAmount, String description, String attach
            , String openid, String wxnotify, HttpServletRequest request) throws Exception {
        SortedMap<String, Object> parameterMap = new TreeMap<>();
        parameterMap.put("appid", appMch.getAppId());
        parameterMap.put("mch_id", appMch.getMchId());
        ...
        logger.info(String.format("=========================[weixinPrePay] requestXML :%s", requestXML));
        String result = httpsRequest("https://api.mch.weixin.qq.com/pay/unifiedorder", "POST", requestXML);
        logger.info(String.format("======================[weixinPrePay] result :%s", result));
        try {
    ...
    private static String createSign(SortedMap<String, Object> parameters) {
        ...
        sb.append("key=").append(appMch.getApiKey());
        logger.info(String.format("======================[createSign] sb:%s", sb.toString()));
    ...
    public static boolean isTenpaySign(Map<String, String> map) {
        ...
        logger.info(String.format("=======================服务器回包里面的签名是:%s", signFromAPIResponse));
        //过滤空 设置 TreeMap
    ...
    private static String httpsRequest(String requestUrl, String requestMethod, String outputStr) {
        try {
            ...
            logger.error("===============[httpsRequest] error", ce);
        } catch (Exception e) {
