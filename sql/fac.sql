...
CREATE TABLE `fac_order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单号,eg:201812231410342545',
  `prod_ids` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '当前订单里包含的商品id，多个商品以逗号分隔',
  ...
  `user_id` bigint(20) DEFAULT 0 COMMENT '买者用户id',
  ...
  `user_score` smallint DEFAULT 0 COMMENT '当前订单使用的积分数',
  `remark` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '用户订单备注',
  `remark_mngt` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '管理员卖家备注',
  `pay_time` datetime DEFAULT NULL COMMENT '付款时间',
  `writeoff_time` datetime DEFAULT NULL COMMENT '核销时间',
  `ship` tinyint(2) NOT NULL DEFAULT 2 COMMENT '是否发货:1-已发货;2-未发货',
  `ship_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '快递单号wid',
  ...
  `update_time` datetime DEFAULT '0000-01-01 00:00:00' COMMENT '最近更新时间',
...
CREATE TABLE `fac_buyer_sign` (
  ...
  `type` tinyint(4) DEFAULT '0' COMMENT '积分类型：0-签到;1-购物反赠积分,2-购物消费,3-用户每次订单实际消费金额',
  `point` smallint  DEFAULT '0' COMMENT '积分数',
  `mount` decimal(8,2) DEFAULT '0.00' COMMENT '当前消费的金额：钱',
...
-- 14、订单商品信息表
-- --------------------------
drop table if exists `fac_order_product`;
CREATE TABLE `fac_order_product` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单号,eg:201812231410342545',
