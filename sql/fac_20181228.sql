...
CREATE TABLE `fac_product` (
  ...
  `ship_mode` tinyint(2) NOT NULL COMMENT '发货方式',
  `ship_cost` decimal(5,2) NOT NULL COMMENT '运费',
...
CREATE TABLE `fac_business` (
  ...
  `contacts2` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '联系人2',
  `contacts3` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '联系人3',
  `phone_number1` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '电话1',
  `phone_number2` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '电话2',
  `phone_number3` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '电话3',
  ...
  `secret` tinyint(1) NOT NULL COMMENT '是否加密处理',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '最近更新时间',
  `operator_id` bigint(20) DEFAULT NULL COMMENT '操作者ID',
  `operator_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '操作者姓名',
